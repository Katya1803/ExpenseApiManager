...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler
{
    ...
    public ResponseEntity<ErrorObject> handleMethodArgumentTypeMismatchException(ResourceNotFoundException ex, WebRequest request){
        ErrorObject errorObject = new ErrorObject();
    ...
    public ResponseEntity<ErrorObject> handleGeneralException(ResourceNotFoundException ex, WebRequest request){
        ErrorObject errorObject = new ErrorObject();
